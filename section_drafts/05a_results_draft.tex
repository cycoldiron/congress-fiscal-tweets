...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, coltitle=black, opacityback=0, leftrule=.75mm, colback=white, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white, left=2mm, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, toptitle=1mm, arc=.35mm, titlerule=0mm, rightrule=.15mm, bottomrule=.15mm]
...
\includegraphics[width=0.75\linewidth,height=\textheight,keepaspectratio]{../figures/individuals/density_pct_deficit_by_party_overall.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{../figures/individuals/density_in_minus_out_overlay.png}
...
for historical and contemporary American fiscal policy. \FloatBarrier
