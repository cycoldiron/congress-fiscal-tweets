...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colback=white, coltitle=black, leftrule=.75mm, colframe=quarto-callout-important-color-frame, breakable, opacityback=0, toptitle=1mm, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, titlerule=0mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, arc=.35mm, left=2mm, opacitybacktitle=0.6, bottomtitle=1mm, rightrule=.15mm]
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{../figures/economic_indicators/deficit_share_vs_inflation_smoothed.png}
...
\includegraphics[width=0.75\linewidth,height=\textheight,keepaspectratio]{../figures/individuals/hist_pct_deficit_by_party.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{../figures/individuals/box_party_split_by_power.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{../figures/individuals/hist_in_minus_out_overlay.png}
...
\includegraphics[width=0.75\linewidth,height=\textheight,keepaspectratio]{../figures/leadership/leader_deficit_tweets.png}
...
fiscal policies. The two messaging strategies employed by party leaders
reflect a broader division in party dynamics between Democrats and the
GOP. These results provide nuance to our understanding of the
communication strategies of key political figures, such as
Representative Ryan and Senator McConnell, whose ``deficit'' messaging
has had significant implications for historical and contemporary
American fiscal policy. \FloatBarrier
...
@fig--deficit-share-by-party reports the conditional share of tweets
mentioning the deficit within ±1-month windows around major bills, split
by party (with a pooled/overall column for reference). At baseline,
Republicans tweet about the deficit more often 0.8\% than Democrats
0.6\% -- a gap that persists across most legislative windows. During the
Inflation Reduction Act (2022) and CHIPS Act (2022) periods,
...
to provide a framework for their interpretation first. The coeﬀicients
...
model includes majority interaction coeﬀicients of the general form GOP
× Conditioning Variable. These coeﬀicients indicate whether the baseline
...
coeﬀicient GOP × Legislative window × Minority presidency reveals a
