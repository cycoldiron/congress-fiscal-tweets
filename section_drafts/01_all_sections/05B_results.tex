...
\urlstyle{same}
\hypersetup{
  pdftitle={Empirical Results: Deficit Rhetoric Across Political Contexts},
...
\title{Empirical Results: Deficit Rhetoric Across Political Contexts}
\author{Cy Coldiron}
\date{2026-04-07}
\begin{document}
\maketitle
...
\section{Empirical Results: Deficit Rhetoric Across Political
Contexts}\label{empirical-results-deficit-rhetoric-across-political-contexts}
